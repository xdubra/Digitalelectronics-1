...
![Screenshot od EDA Playground](image5/Prve.png)
...
### Image of the top layer including both counters, a 4-bit bidirectional counter and a 16-bit counter with a different time base
![Screenshot od EDA Playground](image5/Tretie.png)
