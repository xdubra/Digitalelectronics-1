...
| **clk** | **d** | **q(n)** | **q(n+1)** | **Comments** |
   | :-: | :-: | :-: | :-: | :-- |
   | ![rising](image7/eq_uparrow.png) | 0 | 0 | 0 | Input signal is sampled at the rising edge of clk and stored to FF |
   | ![rising](image7/eq_uparrow.png) | 0 | 1 | 0 | Input signal is sampled at the rising edge of clk and stored to FF |
   | ![rising](image7/eq_uparrow.png) | 1 | 0 | 1 | Input signal is sampled at the rising edge of clk and stored to FF |
   | ![rising](image7/eq_uparrow.png) | 1 | 1 | 1 | Input signal is sampled at the rising edge of clk and stored to FF |

   | **clk** | J | K | Qn | Q(n+1) | Comments |
   | :-: | :-: | :-: | :-: | :-: | :-- |
   | ![rising](image7/eq_uparrow.png)  | 0 | 0 | 0 | 0 | No change |
   | ![rising](image7/eq_uparrow.png) | 0 | 0 | 1 | 1 | No change |
   | ![rising](image7/eq_uparrow.png) | 0 | 1 | 0 | 0 | Reset |
   | ![rising](image7/eq_uparrow.png) | 0 | 1 | 1 | 0 | Reset |
   | ![rising](image7/eq_uparrow.png) | 1 | 0 | 0 | 1 | Set |
   | ![rising](image7/eq_uparrow.png)  | 1 | 0 | 1 | 1 | Set |
   | ![rising](image7/eq_uparrow.png) | 1 | 1 | 0 | 1 | Toggle |
   | ![rising](image7/eq_uparrow.png) | 1 | 1 | 1 | 0 | Toggle |

   | **clk** | T | Qn | Q(n+1) | Comments |
   | :-: | :-: | :-: | :-: | :-- |
   | ![rising](image7/eq_uparrow.png) | 0 | 0 | 0 | No change |
   | ![rising](image7/eq_uparrow.png) | 0 | 1 | 1 | No change |
   | ![rising](image7/eq_uparrow.png) | 1 | 0 | 1 | Invert |
   | ![rising](image7/eq_uparrow.png) | 1 | 1 | 0 | Invert |
